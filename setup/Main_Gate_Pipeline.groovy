...
pipeline {
	...
	options { timestamps() }
	stages {
		stage('Enter') { steps { build 'DEMO-CI-010-Main-Entry' } }
		...
		stage('Relesae-Gate-Entry') { steps { build 'DEMO-CI-600-Relesae-Gate-Entry' } }
		stage('Relesae-Gate-Prepare') { steps { build 'DEMO-CI-610-Relesae-Gate-Prepare' } }
